...
export const productType={vegetables:"Vegetables",fruite:"Fruite",dairyProduct:"Dairy product",meat:"Meat",driedFruite:"Dried fruits",drinkFruite:"Fruite juice"}
...
function ProductProvider(props) {
    const [productList, setProductList] = useState(
        [
            ...
            { name: "Yogurt", price: 8, id: uuidv4(), type: productType.dairyProduct, img: productImg.yogurt  },
            ...
            { name: "Chicken nuggets", price: 12, id: uuidv4(), type: productType.meat, img: productImg.nuggets },
            { name: "Nuggets with legs", price: 16, id: uuidv4(), type: productType.meat, img: productImg.legNuugets },
            ...
            { name: "Dried apricots", price: 7, id: uuidv4(), type: productType.driedFruite, img: productImg.apricot },
            { name: "Mixed fruits juice", price: 9, id: uuidv4(), type: productType.drinkFruite, img: productImg.mixJuice },
            { name: "Orange juice", price: 6, id: uuidv4(), type: productType.drinkFruite, img: productImg.orangeJuice },
            { name: "Summer fruits juice", price: 4, id: uuidv4(), type: productType.drinkFruite, img: productImg.summerJuice },
        ]
    )
