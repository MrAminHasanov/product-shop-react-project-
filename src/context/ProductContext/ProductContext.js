...
function ProductProvider(props) {
    const [productList,setProducList] = useState(
        [
            ...
            { name: "Nugget legs", price: 16, id: 9, type: productType.meat, img: productImg.legNuugets },
            { name: "Apple", price: 3, id: 10, type: productType.fruite, img: productImg.apple },
            { name: "Orange", price: 4, id: 11, type: productType.fruite, img: productImg.orange },
            { name: "Mango", price: 5, id: 12, type: productType.fruite, img: productImg.mango },
            { name: "Dried apricots", price: 7, id: 13, type: productType.driedFruite, img: productImg.apricot },
